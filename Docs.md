# Nix Library
This documentation is for the stable release of Nix Library.
...
## Creating a Window
```lua
local Window = NixLib:MakeWindow({Name = "Title of the library", HidePremium = false, SaveConfig = true, ConfigFolder = "NixTest"})
...
print(NixLib.Flags["toggle"].Value) -- prints the value of the toggle.
```
